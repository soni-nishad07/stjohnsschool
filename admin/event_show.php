                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($images as $img): ?>
                                <?php if (trim($img) !== ''): ?>
                                    <img src="../uploads/<?= htmlspecialchars(trim($img)) ?>" alt="Event Image" width="60" class="mb-1 me-1">
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </td>
                        <td>
                            <a href="event_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary mb-1">Edit</a><br>
                            <a href="event_delete.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
                </tbody>
