        ...
        <div class="container">
            ...
            <div class="news_list">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    ...
                    <div class="news_item">
                        <div class="news_date">
                            <span class="news_month"><?php echo $month ?></span>
                            <span class="news_day"><?php echo $day ?></span>
                            <span class="news_year"><?php echo $year ?></span>
                        </div>
                        <div class="news_content">
                            <h4 class="news_heading"><?php echo htmlspecialchars($row['title']) ?></h4>
                            <p class="news_category"><?php echo htmlspecialchars($row['category']) ?></p>
                        </div>
                    </div>
                <?php endwhile; ?>
    ...
    <section class="home_glance_section">
        ...
        <div class="home_glance_cards">
            ...
            while ($row = $result->fetch_assoc()):
                $image = ! empty($row['image']) ? 'uploads/house/' . $row['image'] : 'default.png'; // fallback image
            ?>
                <div class="home_glance_card flip-card zoom-in">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            <img src="<?php echo $image ?>" alt="<?php echo htmlspecialchars($row['house_name']) ?>" class="flower-icon" style="width: 80px; height: 80px; object-fit: cover; border-radius: 50%;">
    ...
    <section class="home_glance_testimonials">
        ...
        <div class="home_glance_testimonial_container">
            ...
            <div class="home_glance_testimonial_wrapper" id="testimonialWrapper">
                ...
                <div class="home_glance_testimonial_group">
                    <div class="home_glance_testimonial_card">
                        <p>St. John's High School has been a wonderful experience for my child, Krithik. The school campus is spacious, providing a comfortable and open environment that encourages learning and play. The teachers are well-educated, approachable, and genuinely invested in the students’ academic and personal growth, always willing to go the extra mile to ensure every child succeeds.
                            The school is well-equipped with a science lab, computer lab, and a good library, giving students access to essential resources for hands-on learning and research. One of the standout features is the wide variety of sports and games offered, which allows children to discover and develop their athletic talents while learning the values of teamwork and discipline.
                            St. John's High School also organizes a lot of events and extracurricular activities, keeping students active and engaged beyond the classroom. These opportunities help children like Krithik explore new interests, build confidence, and form lasting friendships. The school’s commitment to holistic education is evident in how it promotes not just academic achievement, but also personal growth and overall development.
                            Overall, I am very satisfied with St. John's High School and highly recommend it to any parent looking for a nurturing, well-rounded educational environment for their child.
                        </p>
                        <div class="home_glance_author">Geeta(Parent)</div>
                    </div>
                    <div class="home_glance_testimonial_card">
                        <p>
                            As a proud ex-student of St. John's, I can confidently say that the school provided me with an excellent foundation for life. The well-trained teachers offered not only academic excellence but also personal care in studies, ensuring every student received the support they needed. The school also maintained exact care in hygiene and health, creating a safe and clean environment for all of us.
                            I carry with me many unforgettable memories, both inside and outside the classroom. What truly stood out was the extended support from the school management, both during my time as a student and even after graduation, helping shape a bright and successful future.
                            I'm truly proud to be a part of the St. John's family.
                        </p>
                ...
                <div class="home_glance_testimonial_group">
                    <div class="home_glance_testimonial_card">
                        <p>To most people, St. John's High School might just seem like another school.
                            But for me, it was so much more -it was my launchpad.
                            It’s where I discovered what I was capable of and my identity was shaped with every lesson and moment.
                            Our Principal wasn’t just someone who ran the school they were its heart and soul.
                            They led with strength, with care, their belief in our potential made is believe in ourselves.
                            And the teachers? They were amazing. Patient, passionate, and always there not just to teach us lessons from textbooks, they prepared us for life.
                            The friendships I made, the values I learned, the little moments that became big memories
                            they’ve stayed with me, every step of the way.
                            St. John's wasn’t just the place I went to school. It’s where I became.
                        </p>
...
<script>
  ...
  let autoSlide = setInterval(nextGroup, 5000);

  function resetAutoSlide() {
    clearInterval(autoSlide);
    autoSlide = setInterval(nextGroup, 5000);
  }
</script>
